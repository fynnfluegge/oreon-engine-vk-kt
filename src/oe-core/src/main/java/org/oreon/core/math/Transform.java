...
public class Transform {
	...
	{
		return BaseContext.Companion.getCamera().getViewProjectionMatrix().mul(getWorldMatrix());
	}
	
	public Matrix4f getOriginModelViewProjectionMatrix()
	{
		return BaseContext.Companion.getCamera().getOriginViewProjectionMatrix().mul(getWorldMatrix());
	}
	
	public Matrix4f getXzOriginModelViewProjectionMatrix()
	{
		return BaseContext.Companion.getCamera().getXzOriginViewProjectionMatrix().mul(getWorldMatrix());
	}
