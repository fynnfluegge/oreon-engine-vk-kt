...
class FrameBufferDepthAttachment(device: VkDevice?, memoryProperties: VkPhysicalDeviceMemoryProperties?,
    ...
    init {
        image = Image2DDeviceLocal(device, memoryProperties, width, height, format,
                VK10.VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT or VK10.VK_IMAGE_USAGE_SAMPLED_BIT,
                samples)
